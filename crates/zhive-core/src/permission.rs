...
#[doc(inline)]
pub use pending::{PendingPermissions, RequestKey};
...
impl PermissionReducer {
    ...
    /// # Errors
    ///
    /// Returns [`ReducerError::Abandoned`] when the waiter is dropped
    ...
    pub async fn wait(
        ...
        match tokio::time::timeout(self.timeout, rx).await {
            ...
            Err(_elapsed) => Ok(PermissionOutcome::Cancelled),
        }
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn timeout_resolves_to_cancelled() {
